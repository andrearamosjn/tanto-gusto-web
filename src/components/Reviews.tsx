...
const reviews = [
  ...
  },
  {
    author: "Nisha G.",
    rating: 5,
    text: "Me encantaron las empanadas, la persona detrás del mostrador era sonriente y muy agradable y sirvió las variedades de empanadas con gran pasión!",
    location: "Sitges",
    timeAgo: "oct 2025",
  ...
  },
  {
    author: "Christine H.",
    rating: 5,
    text: "Las empanadas se hornean en el momento para ti, deliciosas y frescas. Mucho mejor que cualquiera que hayas probado antes. Vegano, carne, vegetariano, todo genial.",
    location: "Sitges",
    timeAgo: "mar 2025",
    source: "tripadvisor" as const,
  },
...
function TripAdvisorIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-label="TripAdvisor">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="#34E0A1" />
      <circle cx="8.5" cy="12" r="2.5" fill="white" />
      <circle cx="15.5" cy="12" r="2.5" fill="white" />
      <circle cx="8.5" cy="12" r="1.2" fill="#1a1918" />
      <circle cx="15.5" cy="12" r="1.2" fill="#1a1918" />
      <path d="M12 8.5c-1.5 0-2.8.5-3.8 1.3L7 8.5h10l-1.2 1.3c-1-.8-2.3-1.3-3.8-1.3z" fill="#1a1918" />
      <path d="M12 15.5l-1-1.5h2l-1 1.5z" fill="#FF5722" />
    </svg>
  );
}
        ...
        <div className="mb-12 flex flex-col items-center gap-3 text-center">
          ...
          <div className="flex flex-col items-center gap-4 mt-2">
            <div className="flex items-center gap-6">
              <a
                href="https://www.google.com/maps/search/Tanto+Gusto+comida+con+amor/@41.97,1.3,8z"
                target="_blank"
